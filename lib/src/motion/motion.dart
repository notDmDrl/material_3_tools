...
abstract class Motion {
  ...
  static const MotionPair selectionMotion =
      MotionPair(Easing.standard, MotionDuration.short4);
  ...
  static const MotionPair fabExpandingMotion =
      MotionPair(Easing.emphasized, MotionDuration.medium4);
  ...
  static const MotionPair cardExpansionMotion =
      MotionPair(Easing.emphasized, MotionDuration.long2);
  ...
  static const MotionPair ambientCarouselMotion =
      MotionPair(Easing.emphasized, MotionDuration.long4);
}

/// Combination of easing and duration.
// TODO(notDmDrl): replace with record.
@immutable
class MotionPair {
  /// Creates [MotionPair].
  const MotionPair(this.easing, this.duration);
